...
- You can now drag & drop project files directly into BP Studio app on desktops.
...
- 0.7.12: Fixes a fatal error in edge cases and recent file list on mobiles, and adds dropzone.
- 0.7.13: Introduces parallel-computation in Optimizer, and fixes an edge-case fatal error in contour rendering.
- 0.7.14: Fixes two minor UI bugs.
- 0.7.15: User manual now has all languages, fixes an edge-case fatal error in tree re-balancing.
