<template>
	...
	<div class="panel-grid">
		<Number
			...
			:label="$t('panel.edge.length')"
			:min="1"
			:max="subject.maxLength"
			hotkeys="d.rd,d.ri"
		/>
	</div>
	<div class="mt-3">
		<AsyncButton class="me-2" :disabled="subject.cannotSplit" :click="() => subject.split()">
			{{ $t("panel.edge.split") }}
		</AsyncButton>
	...
	<div class="mt-3">
		<button class="btn btn-primary" :title="hk('n', 'd')" @click="subject.goToDual()">
