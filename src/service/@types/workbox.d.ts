...
import * as broadcaseUpdate from 'workbox-broadcast-update/index';
...
export { backgroundSync, broadcaseUpdate, cacheableResponse, core, expiration, googleAnalytics, navigationPreload, precaching, rangeRequests, routing, strategies, streams };
