...
Vue.component('row', { render() { with (this) {
        return _c('div', { staticClass: "panel-row" }, [_c('div', { staticClass: "col-form-label" }, [_v(_s(label))]), _v(" "), _c('div', [_t("default")], 2)]);
    } }, props: { label: String } });
