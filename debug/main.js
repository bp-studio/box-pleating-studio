...
Vue.component('row', { render() { with (this) {
        return (label) ? _c('div', { staticStyle: { "display": "contents" } }, [_c('div', { staticClass: "col-form-label" }, [_v(_s(label))]), _v(" "), _c('div', [_t("default")], 2)]) : _c('div', { staticStyle: { "grid-column-end": "span 2" } }, [_t("default")], 2);
    } }, props: { label: String } });
...
Vue.component('repository', { render() { with (this) {
        return _c('div', [_c('h5', { directives: [{ name: "t", rawName: "v-t", value: ('panel.repo.type'), expression: "'panel.repo.type'" }], staticClass: "panel-title" }), _v(" "), (repository.size == 1 && repository.entry.size == 1) ? _c('div', { staticClass: "row" }, [_c('label', { directives: [{ name: "t", rawName: "v-t", value: ('panel.repo.onlyOne'), expression: "'panel.repo.onlyOne'" }], staticClass: "col-form-label col" })]) : _c('div', { staticClass: "panel-grid" }, [(repository.size > 1) ? _c('store', { attrs: { "data": repository, "label": $t('panel.repo.config') } }) : _e(), _v(" "), (repository.entry.size > 1) ? _c('store', { attrs: { "data": repository.entry, "label": $t('panel.repo.pattern') } }) : _e()], 1)]);
    } }, props: { repository: Object } });

Vue.component('river', { render() { with (this) {
        return _c('div', [_c('h5', { directives: [{ name: "t", rawName: "v-t", value: ('panel.river.type'), expression: "'panel.river.type'" }], staticClass: "panel-title" }), _v(" "), _c('div', { staticClass: "panel-grid" }, [_c('number', { attrs: { "label": $t('panel.river.width'), "min": 0 }, model: { value: (selection.length), callback: function ($$v) { $set(selection, "length", _n($$v)); }, expression: "selection.length" } })], 1), _v(" "), _c('div', { staticClass: "mt-3" }, [_c('button', { directives: [{ name: "t", rawName: "v-t", value: ('keyword.delete'), expression: "'keyword.delete'" }], staticClass: "btn btn-primary", on: { "click": function ($event) { return selection.delete(); } } })]), _v(" "), _c('div', { staticClass: "mt-3" }, [_c('button', { directives: [{ name: "t", rawName: "v-t", value: ('panel.river.goto'), expression: "'panel.river.goto'" }], staticClass: "btn btn-primary", on: { "click": function ($event) { return design.riverToEdge(selection); } } })])]);
    } }, mixins: [BaseComponent] });

Vue.component('vertex', { render() { with (this) {
        return _c('div', [_c('h5', { directives: [{ name: "t", rawName: "v-t", value: ('panel.vertex.type'), expression: "'panel.vertex.type'" }], staticClass: "panel-title" }), _v(" "), _c('div', { staticClass: "panel-grid" }, [_c('field', { attrs: { "label": $t('panel.vertex.name') }, model: { value: (selection.name), callback: function ($$v) { $set(selection, "name", $$v); }, expression: "selection.name" } })], 1), _v(" "), _c('div', { staticClass: "mt-3 d-flex", staticStyle: { "flex-wrap": "wrap" } }, [_c('button', { directives: [{ name: "t", rawName: "v-t", value: ('panel.vertex.addLeaf'), expression: "'panel.vertex.addLeaf'" }], staticClass: "btn btn-primary flex-shrink-0", on: { "click": function ($event) { return selection.addLeaf(newLength); } } }), _v(" "), _c('div', { staticClass: "flex-grow-1 d-flex justify-content-end", staticStyle: { "flex-basis": "150px", "width": "0px" } }, [_c('label', { staticClass: "col-form-label mx-2 flex-shrink-0" }, [_v(_s($t('panel.vertex.ofLength')))]), _v(" "), _c('div', { staticClass: "flex-grow-1", staticStyle: { "max-width": "calc(200px - 50%)" } }, [_c('number', { attrs: { "min": 1 }, model: { value: (newLength), callback: function ($$v) { newLength = $$v; }, expression: "newLength" } })], 1)])]), _v(" "), (design.tree.node.size > 3) ? _c('div', { staticClass: "mt-3" }, [(selection.degree == 1) ? _c('button', { directives: [{ name: "t", rawName: "v-t", value: ('keyword.delete'), expression: "'keyword.delete'" }], staticClass: "btn btn-primary", on: { "click": function ($event) { return selection.delete(); } } }) : _e(), _v(" "), (selection.degree == 2) ? _c('button', { directives: [{ name: "t", rawName: "v-t", value: ('panel.vertex.delJoin'), expression: "'panel.vertex.delJoin'" }], staticClass: "btn btn-primary", on: { "click": function ($event) { return selection.deleteAndJoin(); } } }) : _e()]) : _e(), _v(" "), (selection.degree == 1) ? _c('div', { staticClass: "mt-3" }, [_c('button', { directives: [{ name: "t", rawName: "v-t", value: ('panel.vertex.goto'), expression: "'panel.vertex.goto'" }], staticClass: "btn btn-primary", on: { "click": function ($event) { return design.vertexToFlap(selections); } } })]) : _e()]);
